...
def main():
    while True:
        ...
        if info in ["a", "commands", "ingame commands", "in-game commands", "ingamecommands"]:
            ...
            {colored('If you want to speed up making money, you can buy a word shortener in the shop so you only have to enter "m" to get money.', "yellow")}
            {colored('If you want to get more multipliers for cheaper, buy a "Super Multiplier" which is an upgrade unlocked at Multiplier Level 15 that allows you to get 5 multipliers for the price of 3 of your current ones!', "yellow")}
